...
<ac:structured-macro ac:name="panel" ac:schema-version="1" ac:macro-id="77bbcea4-63ac-4d98-b68a-8b7be24e57de"><ac:parameter ac:name="panelIconId">0b885b7f-2b42-41b1-8a5e-</ac:parameter><ac:parameter ac:name="panelIcon">:Growth_purple:</ac:parameter><ac:parameter ac:name="bgColor">#EAE6FF</ac:parameter><ac:parameter ac:name="panelIconText">🌱</ac:parameter><ac:rich-text-body><h2><strong><span style="color: rgb(64,50,148);">Welcome to Confluence!</span></strong></h2><p>There&rsquo;s a lot that Confluence and Jira can do together&mdash;this page is a reference and resource for successfully incorporating both into your team&rsquo;s workflow. Feel free to come back to it as often as you like.</p></ac:rich-text-body></ac:structured-macro><h2><strong><span style="color: rgb(101,84,192);">Confluence &amp; Jira Together</span></strong></h2><a href="https://www.youtube.com/watch?v=ohtDFXNAUns" data-layout="center" data-original-height="480.00" data-width="100.00" data-original-width="853.34" data-card-appearance="embed" title="Confluence and Jira Software are Better Together">https://www.youtube.com/watch?v=ohtDFXNAUns</a><p /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell>
<h2><ac:emoticon ac:emoji-shortname=":bar_chart:" ac:emoji-id="1f4ca" ac:emoji-fallback="📊" />&nbsp;Display Jira work in Confluence</h2><p>View work across Atlassian by embedding Jira links directly into Confluence. Jira embeds enable you to preview status changes and other details of Jira work items, without leaving Confluence.</p></ac:layout-cell><ac:layout-cell>
<ac:image ac:align="center" ac:width="356"><ri:url ri:value="https://dam-cdn.atl.orangelogic.com/AssetLink/gm6ags8xaw502rf0o8j74u1324u01fke.png" /></ac:image><p /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell>
<h2><ac:emoticon ac:emoji-shortname=":left_right_arrow:" ac:emoji-id="2194" ac:emoji-fallback="&harr;️" />&nbsp;Move between Jira &amp; Confluence</h2><p>When you add a Jira work item in Confluence or link to a Confluence page from Jira, the <code>Jira work items</code> field appears in the Confluence page details panel. his allows quick navigation between Confluence and Jira, enhancing your workflow.</p></ac:layout-cell><ac:layout-cell>
<ac:image ac:align="center" ac:width="356"><ri:url ri:value="https://dam-cdn.atl.orangelogic.com/AssetLink/1o10hqya3eerki7ev105vm58fi3p8m12.png" /></ac:image><p /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="fixed-width"><ac:layout-cell>
<p /><ac:task-list>
<ac:task>
<ac:task-id>2434</ac:task-id>
<ac:task-status>incomplete</ac:task-status>
<ac:task-body><span class="placeholder-inline-tasks">Paste a link to one of your existing Jira work items to embed it as a smart link.</span></ac:task-body>
</ac:task>
</ac:task-list><p /><hr /><h2><strong><span style="color: rgb(101,84,192);">Confluence 101</span></strong></h2><h3>🗃️ Spaces</h3></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell>
<p>Spaces are where teams organize ideas, projects, and documentation. Spaces can be customized and integrated with both Atlassian tools and others.</p><p>Spaces can be organized with <a href="https://support.atlassian.com/confluence-cloud/docs/use-folders-to-organize-your-work/">folders</a>, and you can drag and drop to reorder or nest content so you can more effectively share your work with others.</p><p><a href="https://www.atlassian.com/software/confluence/guides/get-started/set-up">More about spaces</a></p></ac:layout-cell><ac:layout-cell>
<ac:image ac:align="center" ac:alt="spaces.png" ac:height="362" ac:width="587"><ri:url ri:value="https://dam-cdn.atl.orangelogic.com/AssetLink/5mjuo77m8cmok83b386225unkp26bq52.png" /></ac:image></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="fixed-width"><ac:layout-cell>
<ac:task-list>
<ac:task>
<ac:task-id>2435</ac:task-id>
<ac:task-status>incomplete</ac:task-status>
...
</ac:task-list><p /><hr /><h2><strong><span style="color: rgb(101,84,192);">Making purposeful content</span></strong></h2><p /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell>
<h3>✏️ Real-time editing</h3><p>You and up to 30 teammates can edit a page together - live - in real time. Changes save and sync automatically so that everyone editing sees the same thing.</p><p><a href="https://support.atlassian.com/confluence-cloud/docs/create-and-collaborate-with-live-editing-in-confluence/">More about live editing</a></p><p /><p /></ac:layout-cell><ac:layout-cell>
...
<p /></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="two_equal"><ac:layout-cell>
<h3>🧰 Elements</h3><p>Elements are tools like info panels, action items, and layouts, designed to help you make your pages more powerful.</p><p><a href="https://support.atlassian.com/confluence-cloud/docs/insert-elements-into-a-page/">More about live elements</a></p></ac:layout-cell><ac:layout-cell>
...
<ac:image ac:align="center" ac:alt="Onboarding.png" ac:width="360"><ri:url ri:value="https://dam-cdn.atl.orangelogic.com/AssetLink/57bb01ljg1764455oa877tv2vlld3t5j.png" /></ac:image><p>&nbsp;</p></ac:layout-cell></ac:layout-section><ac:layout-section ac:type="fixed-width"><ac:layout-cell>
<p style="text-align: right;"><a href="#On-this-page">Back to top ⤴</a></p></ac:layout-cell></ac:layout-section></ac:layout>
